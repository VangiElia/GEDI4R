...
#'   for a given region of interest and date range. This function is taken from
#'   the package rGEDI, developed by Silva et al., (2020) the original code can
#'   be found at https://github.com/carlos-alberto-silva/rGEDI.
#'
