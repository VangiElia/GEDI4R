...
l4_plotprofile <- function (gediL4, beam_id = "BEAM0000",tct=NULL) {
  ...
  if(beam_id!="all"){
    ...
    plot <- gridExtra::grid.arrange(figure[[1]],
                            figure[[2]],
                            figure[[3]],
                            figure[[4]],
                            figure[[5]],
...
#example
#source("E:/GEDI/getLevel4.R")
#source("E:/GEDI/clipLevel4.R")
#
#clip<- "E:/Elia_backup/dati/Limiti_2016_WGS84_Italia/Limiti01012016/Reg2016_WGS84_g/Reg_2016_WGS84_g.shp"
#l4 <- list.files("E:/GEDI/gedi_4/",full.names = T,pattern = "h5")
#l4 <- l4[10]
#gediL4 <- getLevel4(l4)
#gediL4 <- clipLevel4(gediL4,clip,tree_cover_th = 50)
#plotprofileLevel4(gediL4,beam_id = "all")
